...
import com.example.appnghenhaconline.adapter.tabAdapter.TabOfSingerAdapter
...
class SingerFromLibFragment: Fragment() {
    ...
    private fun event() {
        btnBack.setOnClickListener {
            val fragmentLayout = LibrarySingerFragment()
